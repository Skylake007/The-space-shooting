...
public class UIInvItemSpawner : Spawner
{
	...
	public static string nomalItem = "UIInvItem";
	...
	{
		base.Awake();
		if (UIInvItemSpawner.instance != null) Debug.Log("Only 1 UIInvItemSpawner.cs allow");
	...
	{
		Transform uiItem = this.inventoryCtrl.UIInvItemSpawner.Spawn(UIInvItemSpawner.nomalItem, Vector3.zero, Quaternion.identity);
